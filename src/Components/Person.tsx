...
type PersonStringProps = 'name' | 'eye_color' | 'birth_year' | 'gender' | 'skin_color' | 'hair_color' | 'homeworld'
...
const Person = () => {
    ...
    useEffect(() => {
        ...
        const fetchLuke = async () => {
            ...
            if (!ignore) {
                setPerson({ name: luke.name, eye_color: luke.eye_color, birth_year: luke.birth_year, gender: luke.gender, skin_color: luke.skin_color, hair_color: luke.hair_color, films: luke.films, homeworld: homeworldData.name }); 
            }
        };
